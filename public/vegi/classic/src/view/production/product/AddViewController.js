Ext.define('Vegi.view.production.product.AddViewController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.productionproductadd',
    ...
    onProductEditLoad: function(store, records, successful, operation, eOpts){
        var form = this.getView().down('form');
